...
01 SALES-REPORT BLANK SCREEN
   ...
   05 VALUE "UP ARROW - NEXT PAGE" LINE 22 COL 35.
   05 VALUE "DOWN ARROW - PREVIOUS PAGE" LINE 23 COL 35.
   05 PIC ZZZZ FROM WS-TESTING-VAR LINE 24 COL 35.
   05 PIC 9 TO WS-KEY LINE 25 COL 35.
...
*> 2005 - esc; 2009 - left arrow; 2010 - right arrow;
   PERFORM
      ACCEPT WS-KEY
      MOVE FUNCTION UPPER-CASE(WS-KEY) TO WS-KEY
      IF WS-KEY EQUALS SPACES
      EVALUATE COB-CRT-STATUS
         WHEN 2005
            EXIT PERFORM
            MOVE COB-CRT-STATUS TO WS-TESTING-VAR
         WHEN 2003
            MOVE 01 TO PA-OPTION-CODE
            MOVE WSS0-saleID TO WS-LP-saleID
            MOVE WSS0-saleDate TO WS-LP-saleDate
         ...
         WHEN 2004
            ...
            DISPLAY SPACES BLANK SCREEN
            DISPLAY SALES-REPORT
         WHEN OTHER MOVE COB-CRT-STATUS TO WS-TESTING-VAR
      END-EVALUATE
      END-IF
   END-PERFORM
